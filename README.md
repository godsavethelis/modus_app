...
2. Отправка в Inbox **автоматическая**, сразу после готовности саммари (по спеке — кнопка «Отправить в Modus»). Меньше действий; статус виден бейджем «ОТПР.» в списке и отметкой в деталях.
